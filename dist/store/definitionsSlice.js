...
export const getBasicKeyToByte = createSelector(getSelectedConnectedDevice, (connectedDevice) => {
  const basicKeyToByte = connectedDevice ? getBasicKeyDict(connectedDevice == null ? void 0 : connectedDevice.protocol) : {};
  return connectedDevice ? {basicKeyToByte, byteToKey: getByteToKey(basicKeyToByte)} : {basicKeyToByte: {}, byteToKey: {}};
});
